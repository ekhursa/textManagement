...
app.controller('textManagementCtrl', [
		...
		function ($scope, $http, $rootScope) {
			...
			$scope.submitText = function () {
				...
				$http.get('http://api.openweathermap.org/data/2.5/weather?q=' + $rootScope.formModel.city + '&units=metric&APPID=126e45d0ac2ab9bff45c530cbf7836d7').then(function (response) {
